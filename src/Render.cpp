...
bool IsHDREnabled() { return true; return (s_hdrBufs.Initted() && isHDREnabled && shadersEnabled) ? 1 : 0; }

bool IsHDRAvailable() { return true; return s_hdrBufs.Initted() ? true : false; }
